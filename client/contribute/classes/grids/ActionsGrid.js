        ...
        var _updateCells = function () {
            ...
            $.each(_mechIds, function (i, mId) {
                ...
                $.each(_actionIds, function (i, aId) {
                    ...
                    var $delete_btn = _super.p_addDeleteButton($cell);
                    ...
                    $delete_btn.appendTo($cell).click(function () {
                        if (confirm("Are you sure you want to erase " + _getTitle(mechObj, actionObj))) {
                            _dataHandler.deleteCell(mId, aId, function () {
                                _super.p_callOnGridUpdateRequired();
                            });
                        }
                    });
